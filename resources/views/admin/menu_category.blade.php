  ...
  <div class="container-fluid">
    <div class="col-md-12">
      <div class="card">
        ...
        <input type="hidden" id="store_id" name="store_id" value="{{@$store->user_id}}" ng-init="store_id={{$store->user_id}}">
        <div class="card-body" ng-init="menu={{ $menu }}; category_index = null; menu_index_open = null;menu_index = null;menu_item_index = null; menu_item_details = {};">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body item_all_details">
        <form class="form_valitate" id="category_add_form">
          ...
          <div class="panel" ng-init="category_translations = {{json_encode(old('category_translations') ?: array())}}; category_remove_translations =  []; errors = {{json_encode($errors->getMessages())}};" ng-cloak>
            ...
            <div class="panel-body">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      {!! Form::text('category_translations[@{{$index}}][name]', '@{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_@{{$index}}', 'placeholder' => 'Category name','ng-model' => 'translation.name','maxlength'=> '150']) !!}
              ...
              <div class="card" ng-repeat="translation in translations">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        {!! Form::text('translations[@{{$index}}][name]', '@{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_@{{$index}}', 'placeholder' => 'Menu Name','ng-model' => 'translation.name','maxlength'=> '150']) !!}
