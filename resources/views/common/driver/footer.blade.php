@if (Route::current()->uri() == 'driver/signup' & Route::current()->uri() !== 'login')
<footer class="driver driver-sign-footer" ng-controller="driver_footer">
		...
		<div class="copyright py-4 mt-md-3">
			<div class="d-flex flex-wrap justify-content-center">
				<div class="col-12 col-md-4 text-center order-3 order-md-1 mt-4 mt-md-0">
					<div class="select_lang mt-3">
						{!! Form::select('language',$language, (Session::get('language')) ? Session::get('language') : $default_language[0]->value, ['class' => 'language-selector footer-select selectpicker', 'aria-labelledby' => 'language-selector-label', 'id' => 'driver_language_footer']) !!}
					</div>
				</div>
				...
				<div class="col-12 col-md-3 order-1 order-md-2">
					<ul>
						...
						@endif
						<li>
							<a class="theme-color" href="{{route('help_page',current_page())}}">
	...
	<div class="copyright py-3">
		<div class="col-12 text-center mt-3">
			<p>© 2019 <a href="https://www.quickshopper.co.uk" class="d-inline-block">Quick Shoppper</a> </p>
		</div>
	</div>
</footer>
@endif
...
<footer class="driver driver-sign-footer login" ng-controller="footer">
	...
	<div class="footer-info col-12 pt-4">
		<div class="container">
			...
			<div class="copyright py-3">
				<div class="col-12 text-center mt-3">
					<p>© 2019 <a href="https://www.quickshopper.co.uk" class="d-inline-block">Quick Shoppper</a> Inc.</p>
				</div>
			</div>
		</div>
	</div>
