		...
		<div class="d-flex align-items-center justify-content-between">
			<div class="logo">
				<a href="{{route('driver.home')}}">
					<img class="d-none d-md-inline-block" src="{{url('/')}}/images/quickshopper-logo.svg">
					<img class="d-inline-block d-md-none" src="{{url('/')}}/images/quickshopper-logo.svg">
				</a>
			</div>

			<!-- <a href="javascript:void(0)" class="link-arrow text-uppercase theme-color">
			</a> -->
