			...
			<div class="container">
				<div class="d-md-flex">
					<div class="help-nav col-md-4 col-lg-3 pl-0">
						<ul>
							@foreach($help_category as $help_category)
							<li>
								<a class="help_nav_link {{$help_category->id==$category_id?'active':''}}"  href="{{route('help_category',['page'=>$page,'category_id'=>$help_category->id])}}">
